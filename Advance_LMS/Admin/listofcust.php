                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Active Customer List</h4>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Suspended Customer List</h4>
                                    <div class="table-responsive">
                ...
                <script>
                    $j(document).ready(function() {
                        ...
                        var table = $j('#studentTable').DataTable({
                            "ajax": "custdata.php", // Path to your PHP file
                            "columns": [{
                                    "data": "cus_name"
                                },
                                {
                 ...
                 <script>
                    $j(document).ready(function() {
                        ...
                        var table = $j('#studentTable1').DataTable({
                            "ajax": "custdatasus.php", // Path to your PHP file
                            "columns": [{
                                    "data": "cus_name"
                                },
                                {
