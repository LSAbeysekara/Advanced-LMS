    ...
    ***********************************-->
        ...
        ***********************************-->
            <div class="content-body">
                <h2 style="margin: 15px 0 0 15px;">Course: <?php echo $row['c_name']; ?> </h2>
                <p style="margin: 15px 0 0 15px;">Teacher: <?php echo $row['teacher_name']; ?>   </p>     <p style="margin: 15px 0 0 15px;">No. of Student:<?php echo " 0"; //$row['teacher_name']; ?>   </p>           
