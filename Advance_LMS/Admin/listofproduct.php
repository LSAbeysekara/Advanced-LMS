                                ...
                                <script>
                                    $j(document).ready(function() {
                                            ...
                                            "columns": [{
                                                ...
                                                },
                                                {
                                                    ...
                                                    "render": function(data, type, row) {
                                                        ...
                                                        actionButtons += ' <button class="status-btn btn btn-danger" data-order-id="' + row.pro_id + '">Take Action</button>';
                                        ...
                                        $j('#proTable').on('click', '.view-btn', function() {
                                            ...
                                            window.location.href = 'product.php?id=' + orderId;
                                        });

                                        // Handle click on status button
                                        $j('#proTable').on('click', '.status-btn', function() {
                                            var orderId = $j(this).data('order-id');
