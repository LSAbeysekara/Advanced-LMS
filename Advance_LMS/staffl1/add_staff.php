                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <select name="val-usertype" class="form-control" required>
                                                        ...
                                                        <option value="staffl1">Staff-L1</option>
                                                        <option value="staffl2">Staff-L2</option>
                                                        <option value="staffl3">Staff-L3</option>
                                                    </select>
                                                </div>
                                        </div>
    ...
    ***********************************-->
    <script>
        ...
        function checkEmailAndGenerate() {
            ...
            xhr.open('POST', 'checkEmailExistsstaff.php', true);
