    ...
    <script>
        function handleNoticeTypeChange(selectElement) {
            ...
            if (selectElement.value === 'course') {
                ...
                contentTextarea.removeAttribute('disabled'); // Enable the content textarea
                contentTextarea.style.position = 'relative'; // Show the content textarea
                contentTextarea.style.left = '-9999px'; // Move it off-screen
            } else {
                coursesSection.style.display = 'none';
                courseSelect.disabled = true;
                contentTextarea.setAttribute('disabled', 'disabled'); // Disable the content textarea
                contentTextarea.style.position = 'absolute'; // Hide the content textarea
                contentTextarea.style.left = '0'; // Move it back to its original position
            }
        }
