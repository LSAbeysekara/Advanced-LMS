                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="media align-items-center mb-4">
                                    <img class="mr-3" src="../Student/profile_img/<?php echo $row['pro_img'] ?>" alt="" width="120px" height="120px">
                                    <div class="media-body">
                                        <h3 class="mb-0"><?php echo $row['st_name'] ?></h3>
                                ...
                                <ul class="card-profile__info">
                                    ...
                                    <li><strong class="text-dark mr-4">Email</strong></br> <span><?php echo $row['email'] ?></span></li>
                                    <li><strong class="text-dark mr-4">Date of Birth</strong></br> <span><?php echo $row['date_of_birth'] ?></span></li>
                                    <li><strong class="text-dark mr-4">NIC</strong> </br><span><?php echo $row['nic'] ?></span></li>
