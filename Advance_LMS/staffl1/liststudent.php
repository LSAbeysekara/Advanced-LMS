            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">List of Student</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
...
<script>
    $j(document).ready(function() {
        ...
        var table = $j('#studentTable').DataTable({
            "ajax": "studentdata.php", // Path to your PHP file
            "columns": [
                { "data": "st_name" },
                { "data": "email" },
                { "data": "nic" },
                { "data": "username" },
                { "data": "status" },
                { "data": null, "defaultContent": "<button class='view-btn btn btn-info'>View</button>  &nbsp;&nbsp;<button class='edit-btn btn btn-primary'>Edit</button> &nbsp;&nbsp;<button class='delete-btn btn btn-danger'>Delete</button>" }
            ...
            "createdRow": function (row, data, dataIndex) {
                $j(row).find('.view-btn').on('click', function () {
                    ...
                    window.location.href = 'st_profile.php?id=' + username;
                });
                ...
                $j(row).find('.edit-btn').on('click', function () {
                    ...
                    var username = data.username;
                    // Perform edit action with the username
                    window.location.href = 'edit_student.php?id=' + username;
                });
