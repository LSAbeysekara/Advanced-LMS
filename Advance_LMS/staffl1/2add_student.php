        ...
        <script>
            ...
            function submitForm() {
                ...
                if (usernameField === '' || passwordField === '') {
                    ...
                    Swal.fire(
                                'error!',
                                'Please click the "Generate" button to generate username and password.',
                                'error'
                            );
                    return;
                }
