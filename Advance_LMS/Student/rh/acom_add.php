...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-valide" method="post" action="save_acom.php" enctype="multipart/form-data">

                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label">Title<span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" name="title" placeholder="Enter your accomodation title here.." required  maxlength="20"><span class=""></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control" name="location" id="locationInput" placeholder="Paste your accomodation location's link here.." required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <textarea type="text" class="form-control" name="description" placeholder="Enter a short description here.." id="charLimitedInput" maxlength="45" required></textarea>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-8 ml-auto">
                                                ...
                                                <a href="resource_hub.php"><input type="button" class="btn btn-primary" style="background-color: red;" value="Cancel"></a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
    ...
    ***********************************-->
    ...
    <script>
        // Get the sentence
        const sentence = "Testing description goes here and this is testing and this time word count is good........";
    ...
    <?php if(isset($_SESSION['add-acom-error-no'])){ ?>    
        <script>
            Swal.fire({
                icon: "error",
                title: "Oops...",
    ...
    <?php   unset($_SESSION['add-acom-error-no']); } ?>

    <?php if(isset($_SESSION['add-acom-error-dif'])){ ?>    
        <script>
            Swal.fire({
                icon: "error",
                title: "Oops...",
    ...
    <?php   unset($_SESSION['add-acom-error-dif']); } ?>

    <?php if(isset($_SESSION['add-acom-error'])){ ?>    
        <script>
            Swal.fire({
                icon: "error",
                title: "Oops...",
    ...
    <?php   unset($_SESSION['add-acom-error']); } ?>

    <?php if(isset($_SESSION['add-acom-ok'])){ ?>    
        <script>
            Swal.fire({
                position: "top-end",
                icon: "success",
    ...
    <?php   unset($_SESSION['add-acom-ok']); } ?>
