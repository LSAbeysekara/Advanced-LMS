...
<br/>
  <div class="row justify-content-between">
    ...
    <h1>Welcome to Resource Hub</h1><br>
        ...
        <a href="resource_hub.php?district=<?php echo 'online'; ?>" class="text-blue-600 hover:underline mt-4"><button class="btn btn-info online">Online Courses</button></a>
        </div>
...
<script>
  document.querySelectorAll('svg path').forEach(item => {
    ...
    item.addEventListener('click', event => {
      ...
      window.location.href = `resource_hub.php?district=${districtName}`;
    });
  });
</script>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
    ...
    <?php if(isset($_SESSION['location-get-error'])){ ?>
        <script>
            Swal.fire({
              position: "top-end",
              icon: "error",
    ...
    <?php   unset($_SESSION['location-get-error']); } ?>
</body>
</html>
<?php } ?>