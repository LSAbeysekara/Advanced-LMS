                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-valide" method="post" id="imageForm" action="save_product.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="file" class="form-control" id="img01" name="pro_img01" accept="image/*"><br>
                                                
                                                <input type="file" class="form-control" id="img02" name="pro_img02" accept="image/*" disabled><br>
                                                
                                                <input type="file" class="form-control" id="img03" name="pro_img03" accept="image/*" disabled><br>
                                            </div>
                                        </div>
